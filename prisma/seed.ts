...
async function main() {
  await prisma.$transaction([
    ...
    prisma.comparisonCity.deleteMany(),
    prisma.comparison.deleteMany(),
    prisma.favoriteCity.deleteMany(),
    ...
    prisma.cityIncentive.deleteMany(),
    prisma.cityIndustry.deleteMany(),
    prisma.cityHighlight.deleteMany(),
  ...
  for (const city of cities) {
    const created = await prisma.city.create({
      data: {
        ...
        name: city.name,
        state: city.state,
        region: $Enums.Region[city.region as keyof typeof $Enums.Region],
